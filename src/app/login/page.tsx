    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 sm:p-6">
      <div className="glass-card max-w-md w-full p-6 sm:p-8 relative overflow-hidden">
        ...
        <div className="text-center mb-8 relative z-10">
          ...
          <h1 className="text-2xl font-bold bg-gradient-to-r from-blue-700 to-indigo-600 bg-clip-text text-transparent">Umurava AI</h1>
          <p className="text-slate-500 mt-2 text-sm">Sign in to your Recruiter Account</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-5 relative z-10">
          <div className="space-y-1">
            ...
            <input 
              ...
              className="w-full px-4 py-2.5 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-blue-500/30 transition-all text-sm bg-white"
              placeholder="recruiter@umurava.africa"
            />
          </div>
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full bg-blue-600 hover:bg-blue-700 disabled:opacity-50 text-white py-3 rounded-xl font-medium transition-all shadow-lg shadow-blue-500/30 flex items-center justify-center gap-2 mt-4"
          >
